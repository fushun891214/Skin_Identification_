package com.example.Skin_Identification_.ml;
...
public final class ModelUnquantMetadata {
  @NonNull
  ...
  private ModelUnquantMetadata(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "model_unquant_metadata.tflite", options);
  ...
  @NonNull
  public static ModelUnquantMetadata newInstance(@NonNull Context context) throws IOException {
    return new ModelUnquantMetadata(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static ModelUnquantMetadata newInstance(@NonNull Context context,
      @NonNull Model.Options options) throws IOException {
    return new ModelUnquantMetadata(context, options);
  }
